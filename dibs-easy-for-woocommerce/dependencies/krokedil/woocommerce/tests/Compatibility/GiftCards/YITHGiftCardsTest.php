...
namespace KrokedilNexiCheckoutDeps\Krokedil\WooCommerce\Tests\Compatibility\GiftCards;

use KrokedilNexiCheckoutDeps\Krokedil\WooCommerce\Compatibility\Giftcards\YITHGiftCards;
...
class YITHGiftCardsTest extends TestCase
{
    ...
    public function setUp() : void
    {
        ...
        $this->mock_package = $this->getMockBuilder('KrokedilNexiCheckoutDeps\\Krokedil\\WooCommerce\\KrokedilWooCommerce')->disableOriginalConstructor()->getMock();
