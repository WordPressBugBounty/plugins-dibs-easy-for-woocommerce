 ...
 */
namespace KrokedilNexiCheckoutDeps\Composer;

use KrokedilNexiCheckoutDeps\Composer\Autoload\ClassLoader;
use KrokedilNexiCheckoutDeps\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('KrokedilNexiCheckoutDeps\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
